...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vuetify-loader/lib/loader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/pages/Incomes.vue?vue&type=script&lang=js&":
/*!********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vuetify-loader/lib/loader.js??ref--11-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/pages/Incomes.vue?vue&type=script&lang=js& ***!
  \********************************************************************************************************************************************************************************************************************/
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  watch: {
    options: {
      handler: function handler() {
        ...
        this.fetchIncomeFromServer().then(function (data) {
          _this.incomes = data.items;
          _this.totalIncomes = data.total;
        });
      },
      deep: true
    }
  ...
  methods: {
    fetchIncomeFromServer: function fetchIncomeFromServer() {
      var _this2 = this;
      ...
      if (typeof this.search[0] != "undefined") {
        url = "/api/incomes/?search=".concat(this.search);
      }
    ...
    initIncome: function initIncome() {
      this.editedIncome = {
        id: null,
        title: "",
        description: "",
    ...
    onSaveIncome: function onSaveIncome() {
      var _this3 = this;

      var _this$editedIncome = this.editedIncome,
          title = _this$editedIncome.title,
          description = _this$editedIncome.description,
          amount = _this$editedIncome.amount,
          land_id = _this$editedIncome.land_id,
          user_id = _this$editedIncome.user_id,
          received_at = _this$editedIncome.received_at;
      var income = {
        title: title,
      ...
      if (this.incomeId == null) {
        // console.log("create");
        axios.post("/api/incomes", income).then(function (result) {
          // console.log(result);
          _this3.incomes.push(result.data.data);

          _this3.snackbar = true;
          _this3.isError = false;
          _this3.message = _this3.$t("incomes.created");
        ...
        // console.log('update');
        axios.put("/api/incomes/".concat(this.incomeId), income).then(function (result) {
          // console.log(result.data.data);
          Object.assign(_this3.incomes[_this3.editedIndex], result.data.data);
          _this3.snackbar = true;
          _this3.isError = false;
          _this3.message = _this3.$t("incomes.updated");
        })["catch"](function (error) {
      ...
      this.dialogIncome = false; // console.log("saved");
    },
    deleteItem: function deleteItem(item) {
      var _this4 = this;

      var index = this.incomes.indexOf(item);
      confirm("Are you sure you want to delete this income?") && axios["delete"]("/api/incomes/".concat(item.id)).then(function (result) {
        // console.log(result);
        _this4.incomes.splice(index, 1);

        _this4.snackbar = true;
        _this4.isError = false;
        _this4.message = _this4.$t("incomes.deleted");
      })["catch"](function (error) {
        // console.log(error);
        _this4.snackbar = true;
        _this4.isError = true;
    ...
    onSearchIncome: function onSearchIncome() {
      var _this5 = this;

      this.fetchIncomeFromServer().then(function (data) {
        _this5.incomes = data.items;
        _this5.totalIncomes = data.total;
      });
    },
    onCancelSearch: function onCancelSearch() {
      ...
      this.search = "";
      this.fetchIncomeFromServer().then(function (data) {
        _this6.incomes = data.items;
        _this6.totalIncomes = data.total;
      });
    },
    ...
    editItem: function editItem(income) {
      this.editedIndex = this.incomes.indexOf(income);
      this.incomeId = income.id;
      var getIncome = income;
      getIncome.received_at = moment__WEBPACK_IMPORTED_MODULE_0___default()(getIncome.received_at).format("YYYY-MM-DD");
    ...
    //         });
    // },
    fetchIncomeSelections: function fetchIncomeSelections() {
      var _this7 = this;

      axios.get("/api/users/selections").then(function (result) {
        console.log(result);
        _this7.incomeselections = result.data;
      })["catch"](function (err) {
        console.log(err);
      });
    }
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vuetify-loader/lib/loader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/pages/Incomes.vue?vue&type=template&id=bfeeb11e&":
/*!************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vuetify-loader/lib/loader.js??ref--11-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/pages/Incomes.vue?vue&type=template&id=bfeeb11e& ***!
  \************************************************************************************************************************************************************************************************************************************************************/
                ...
                [
                  _c("v-data-table", {
                    attrs: {
                      ...
                      items: _vm.incomes,
                      options: _vm.options,
                      "server-items-length": _vm.totalIncomes,
                      loading: _vm.loading,
                              ...
                              [
                                ...
                                _c(
                                  "v-btn",
                                  {
                                    ...
                                    on: { click: _vm.initIncome }
                                  },
                                  [
                                    _c("v-icon", [_vm._v("mdi-plus")]),
                                    _vm._v(
                                      "\n                                " +
                                        _vm._s(_vm.$t("New Income"))
                                    )
                                  ],
                                  1
                                ),
                                ...
                                _c(
                                  "v-dialog",
                                  {
                                    ...
                                    model: {
                                      value: _vm.dialogIncome,
                                      callback: function($$v) {
                                        _vm.dialogIncome = $$v
                                      },
                                      expression: "dialogIncome"
                                    }
                                  },
                                  [
                                    _c(
                                ...
                                _c("v-text-field", {
                                  ...
                                  on: {
                                    keyup: function($event) {
                                      ...
                                      return _vm.onSearchIncome($event)
                                    }
                                  },
                                  scopedSlots: _vm._u([
                                    {
...
/***/ "./resources/js/pages/Incomes.vue":
/*!****************************************!*\
  !*** ./resources/js/pages/Incomes.vue ***!
  \****************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Incomes_vue_vue_type_template_id_bfeeb11e___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Incomes.vue?vue&type=template&id=bfeeb11e& */ "./resources/js/pages/Incomes.vue?vue&type=template&id=bfeeb11e&");
/* harmony import */ var _Incomes_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Incomes.vue?vue&type=script&lang=js& */ "./resources/js/pages/Incomes.vue?vue&type=script&lang=js&");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _Incomes_vue_vue_type_template_id_bfeeb11e___WEBPACK_IMPORTED_MODULE_0__["render"],
  _Incomes_vue_vue_type_template_id_bfeeb11e___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/pages/Incomes.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/pages/Incomes.vue?vue&type=script&lang=js&":
/*!*****************************************************************!*\
  !*** ./resources/js/pages/Incomes.vue?vue&type=script&lang=js& ***!
  \*****************************************************************/
/*! exports provided: default */
...
/***/ "./resources/js/pages/Incomes.vue?vue&type=template&id=bfeeb11e&":
/*!***********************************************************************!*\
  !*** ./resources/js/pages/Incomes.vue?vue&type=template&id=bfeeb11e& ***!
  \***********************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vuetify_loader_lib_loader_js_ref_11_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Incomes_vue_vue_type_template_id_bfeeb11e___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vuetify-loader/lib/loader.js??ref--11-0!../../../node_modules/vue-loader/lib??vue-loader-options!./Incomes.vue?vue&type=template&id=bfeeb11e& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vuetify-loader/lib/loader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/pages/Incomes.vue?vue&type=template&id=bfeeb11e&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vuetify_loader_lib_loader_js_ref_11_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Incomes_vue_vue_type_template_id_bfeeb11e___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vuetify_loader_lib_loader_js_ref_11_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Incomes_vue_vue_type_template_id_bfeeb11e___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
